...
public class BoardingPass extends JFrame implements ActionListener{
    ...
    public BoardingPass() {
        ...
        // Updated code for loading image
        URL imageUrl = getClass().getResource("/airlinemanagementsystem/icons/airindia.png");
        if (imageUrl != null) {
            ...
            System.err.println("Image not found. Please check the path.");
        }
