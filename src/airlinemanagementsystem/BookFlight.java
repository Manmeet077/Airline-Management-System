...
public class BookFlight extends JFrame implements ActionListener {
    ...
    public BookFlight() {
        ...
        // Initialize and add JDateChooser
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == fetchButton) {
            ...
            try {
                ...
                String query =  "INSERT INTO reservation VALUES('" + name + "', '" + nationality + "', '" + src + "', '" + des + "', '" + flightname + "', '" + flightcode + "', '" + ddate + "', 'PNR-" + random.nextInt(1000000) + "', 'TIC-" + random.nextInt(10000) + "', '" + aadhar + "')";
